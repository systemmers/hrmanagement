...
def mock_repos(app):
    ...
    with patch('app.domains.company.get_organization_repo', return_value=mock_org_repo):
        yield organization_service, mock_org_repo
...
class TestOrganizationServiceQueries:
    ...
    def test_get_tree_success(self, mock_repos):
        ...
        mock_repo.get_tree.return_value = expected

        result = service.get_tree(root_organization_id=1)

        assert result == expected
        mock_repo.get_tree.assert_called_once_with(root_organization_id=1)

    def test_get_flat_list_success(self, mock_repos):
        """조직 평탄화 목록 조회 성공"""
        service, mock_repo = mock_repos
        expected = [{'id': 1, 'name': '본사'}, {'id': 2, 'name': '개발팀'}]
        mock_repo.get_flat_list.return_value = expected

        result = service.get_flat_list(root_organization_id=1)
    ...
    def test_get_by_id_success(self, mock_repos):
        ...
        mock_repo.find_by_id.return_value = mock_org

        result = service.get_by_id(org_id=1)
    ...
    def test_get_by_id_not_found(self, mock_repos):
        ...
        result = service.get_by_id(org_id=999)
    ...
    def test_get_children_success(self, mock_repos):
        ...
        mock_repo.get_children.return_value = expected

        result = service.get_children(org_id=1)
    ...
    def test_search_success(self, mock_repos):
        ...
        mock_repo.search.return_value = expected

        result = service.search(query='개발', root_organization_id=1)
...
class TestOrganizationServiceStatistics:
    ...
    def test_get_organization_statistics_success(self, mock_repos):
        ...
        mock_repo.get_organization_statistics.return_value = expected

        result = service.get_organization_statistics(root_organization_id=1)
...
class TestOrganizationServiceCRUD:
    ...
    def test_create_organization_success(self, mock_repos):
        ...
        mock_repo.create_organization.return_value = expected
    ...
    def test_update_organization_success(self, mock_repos):
        ...
        expected.id = 1
        expected.name = '수정된팀'
        mock_repo.update_organization.return_value = expected
    ...
    def test_update_organization_not_found(self, mock_repos):
        ...
        result = service.update_organization(org_id=999, data={})
    ...
    def test_deactivate_organization_success(self, mock_repos):
        ...
        result = service.deactivate(org_id=1, cascade=False)
    ...
    def test_deactivate_organization_with_cascade(self, mock_repos):
        ...
        result = service.deactivate(org_id=1, cascade=True)
    ...
    def test_move_organization_success(self, mock_repos):
        """조직 이동 성공"""
        service, mock_repo = mock_repos
        mock_repo.move_organization.return_value = True

        result = service.move_organization(
            org_id=1,
            new_parent_id=2
        )
...
class TestOrganizationServiceValidation:
    ...
    def test_verify_ownership_success(self, mock_repos):
        """조직 소유권 검증 성공"""
        service, mock_repo = mock_repos
        mock_repo.verify_ownership.return_value = True

        result = service.verify_ownership(org_id=1, root_organization_id=10)
    ...
    def test_verify_ownership_fail(self, mock_repos):
        """조직 소유권 검증 실패"""
        service, mock_repo = mock_repos
        mock_repo.verify_ownership.return_value = False
    ...
    def test_code_exists_true(self, mock_repos):
        ...
        result = service.code_exists(code='DEPT001')
    ...
    def test_code_exists_false(self, mock_repos):
        ...
        result = service.code_exists(code='DEPT999')
    ...
    def test_code_exists_with_exclude(self, mock_repos):
        ...
        result = service.code_exists(code='DEPT001', exclude_id=1)

        assert result is False
        mock_repo.code_exists.assert_called_once_with(
