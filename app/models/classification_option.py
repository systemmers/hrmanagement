...
class ClassificationOption(db.Model):
    ...
    VALID_CATEGORIES = [
        ...
        CATEGORY_JOB_ROLE, CATEGORY_JOB_GRADE, CATEGORY_EMPLOYMENT_TYPE,
        CATEGORY_STATUS, CATEGORY_PAY_TYPE, CATEGORY_CONTRACT_TYPE,
        CATEGORY_BANK, CATEGORY_ASSET_TYPE, CATEGORY_LANGUAGE,
        CATEGORY_LANGUAGE_LEVEL, CATEGORY_FAMILY_RELATION
    ]
    ...
    TAB_ORGANIZATION = [CATEGORY_DEPARTMENT, CATEGORY_POSITION, CATEGORY_RANK,
                        CATEGORY_JOB_TITLE, CATEGORY_TEAM, CATEGORY_WORK_LOCATION,
                        CATEGORY_JOB_ROLE, CATEGORY_JOB_GRADE]
