...
class TerminationService:
    ...
    def contract_repo(self):
        ...
        return get_person_contract_repo()

    @property
    def employee_repo(self):
        from app.domains.employee import get_employee_repo
        return get_employee_repo()
    ...
    def data_sharing_settings_repo(self):
        from app.domains.company import get_data_sharing_settings_repo
        return get_data_sharing_settings_repo()

    @property
    def personal_profile_repo(self):
        from app.domains.user import get_personal_profile_repo
        return get_personal_profile_repo()
